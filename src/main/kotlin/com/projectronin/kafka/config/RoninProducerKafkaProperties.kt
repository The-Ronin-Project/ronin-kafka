    ...
    val properties: Properties by lazy {
        Properties()
            .apply {
                ...
                put(VALUE_SERIALIZER_CLASS_CONFIG, RoninEventSerializer::class.qualifiedName)
                ...
                put(INTERCEPTOR_CLASSES_CONFIG, ProducerSubjectKeyInterceptor::class.qualifiedName)
                putAll(configs)
            }
    }
}
